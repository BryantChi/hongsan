...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a class="btn btn-primary float-right"
                       href="{{ localized_route('admin.translationsInfos.create') }}">
    ...
    <div class="content px-3">
        ...
        <div class="card">
            @include('admin.translations_infos.table')
        </div>
    </div>
...
@push('page_scripts')
    ...
    <script>
        $(function() {
            let scrollX_enable = "{{ count($translationsInfos) > 0 ? 1 : 0 }}" == true;
            if($(window).width() > 1200) { scrollX_enable = false }
            else { scrollX_enable = "{{ count($translationsInfos) > 0 ? 1 : 0 }}" == true; }
