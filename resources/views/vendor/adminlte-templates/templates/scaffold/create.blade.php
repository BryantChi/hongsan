    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                ...
                <a href="@{{ localized_route('{!! $config->prefixes->getRoutePrefixWith('.') !!}{!! $config->modelNames->camelPlural !!}.index') }}" class="btn btn-default">@if($config->options->localized) @@lang('crud.cancel') @else Cancel @endif</a>
            </div>
