                            ...
                            <div class="category-body">
                                <ul class="list-unstyled category-list">
                                    <li class="wow fadeInUp" data-wow-delay="0.1s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">類別1</a>
                                    </li>
                                    <li class="wow fadeInUp" data-wow-delay="0.2s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">類別2</a>
                                    </li>
                                    <li class="wow fadeInUp" data-wow-delay="0.3s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">類別3</a>
                                    </li>
                                    <li class="wow fadeInUp" data-wow-delay="0.4s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">類別4</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="brand mb-3">
                            ...
                            <div class="brand-body">
                                <ul class="list-unstyled brand-list">
                                    <li class="wow fadeInUp" data-wow-delay="0.1s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">品牌1</a>
                                    </li>
                                    <li class="wow fadeInUp" data-wow-delay="0.2s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">品牌2</a>
                                    </li>
                                    <li class="wow fadeInUp" data-wow-delay="0.3s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">品牌3</a>
                                    </li>
                                    <li class="wow fadeInUp" data-wow-delay="0.4s">
                                        <a href="{{ localized_route('construction.buy') }}" class="text-18">其他品牌</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
