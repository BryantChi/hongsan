                ...
                <div class="col-lg-12 mt-4">
                    ...
                    <a href="{{ localized_route('catetype') }}">
                        <div class="btn-main01 d-flex align-items-center justify-content-between px-3 py-2 mx-auto wow fadeInUp"
                            ...
                            <span class="icon">
                                <img src="{{asset('assets/images/00-hp/icon_plus_o.png')}}" class="img-fluid" width="26"
                                    alt="">
                            </span>
                        </div>
                    </a>
                ...
                <div class="col-lg-5">
                    <picture>
                        <source srcset="{{asset('assets/images/00-hp/ab_l_pic1024.jpg')}}" media="(min-width: 1024px)"
                            type="image/jpg">
                        <img src="{{asset('assets/images/00-hp/ab_l_pic872.jpg')}}" class="img-fluid hp-ab-img" alt="">
                    </picture>
                </div>
                    ...
                    <div class="mt-4 row align-items-center justify-content-center g-4">
                        <div class="hp-ab-item col-lg-auto col-6 text-center wow fadeInUp" data-wow-delay="0.1s">
                            <div class="hp-ab-icon text-center mb-3">
                                <img src="{{asset('assets/images/00-hp/ab_icon1.png')}}" class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="hp-ab-item col-lg-auto col-6 text-center wow fadeInUp" data-wow-delay="0.1s">
                            <div class="hp-ab-icon text-center mb-3">
                                <img src="{{asset('assets/images/00-hp/ab_icon2.png')}}" class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="hp-ab-item col-lg-auto col-6 text-center wow fadeInUp" data-wow-delay="0.1s">
                            <div class="hp-ab-icon text-center mb-3">
                                <img src="{{asset('assets/images/00-hp/ab_icon3.png')}}" class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="hp-ab-item col-lg-auto col-6 text-center wow fadeInUp" data-wow-delay="0.1s">
                            <div class="hp-ab-icon text-center mb-3">
                                <img src="{{asset('assets/images/00-hp/ab_icon4.png')}}" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="swiper linksSwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand01.jpg')}}" class="img-fluid" alt="友站連結1">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand02.jpg')}}" class="img-fluid" alt="友站連結2">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand03.jpg')}}" class="img-fluid" alt="友站連結3">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand04.jpg')}}" class="img-fluid" alt="友站連結4">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand05.jpg')}}" class="img-fluid" alt="友站連結5">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand06.jpg')}}" class="img-fluid" alt="友站連結6">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand07.jpg')}}" class="img-fluid" alt="友站連結7">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand08.jpg')}}" class="img-fluid" alt="友站連結8">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand09.jpg')}}" class="img-fluid" alt="友站連結9">
                                </a>
                            </div>
                            <div class="swiper-slide animate-hover-15">
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/00-hp/brand10.jp')}}g" class="img-fluid" alt="友站連結10">
                                </a>
                            </div>
                        </div>
    ...
    $.getJSON(
      ...
      function(data) {
        ...
        data.forEach(function(item) {
          $('#location').append(
            $('<option>', { value: item.CityName, text: item.CityName })
          );
        });
      }
    );
